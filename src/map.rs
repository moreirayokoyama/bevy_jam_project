use bevy::{
    ...
    math::{Vec2, Vec3},
    prelude::{default, Commands, Component, Entity, IntoSystemConfigs, Query, Res, Resource, SpatialBundle, With},
            ...
            .with_children(|parent| {
                for col_x in 0..CHUNK_WIDTH {
                    for col_y in 0..BLOCK_Y_COUNT {
                        ...
                        if get_block(x, y, &game_world) == Block::Solid {
                            parent.spawn((
                                SpriteBundle {
                                    sprite: Sprite {
                                        color: Color::WHITE,
                                    ...
                                    transform: Transform::from_translation(Vec3::new(
                                        (col_x * BLOCK_SIZE) as f32,
                                        (col_y * BLOCK_SIZE) as f32,
                                        2.,
...
fn get_block(x: usize, y: usize, game_world: &GameWorld) -> Block {
    if (y as f64) < game_world.surface_height[x] {
        Block::Solid
    } else {
        Block::Air
    }
